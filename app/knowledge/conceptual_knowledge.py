...
class ConceptualKnowledgeSystem:
    ...
    def add_concept(self, concept, related_concepts):
        ...
        self.knowledge_graph.add_or_update_node("ConceptGraph", {"concept": concept, "related_concepts": related_concepts})
    ...
    async def enhance_concept(self, concept):
        ...
        Concept: {concept}
        """
        related_concepts = await self.llm.chat_with_ollama("You are a concept analysis expert.", prompt)
